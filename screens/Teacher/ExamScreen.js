...
const AllExams = [
  {
    ...
    status: "Scheduled",
    statusColor: "#FFC107",
    buttons: ["Grade"]  // Scheduled - only Grade button
  },
  {
    title: "Final Exam",
    date: "August 21, 2025",
    ...
    status: "Completed",
    statusColor: "#4CAF50",
    buttons: ["Grade"]  // Completed - only Grade button
  },
  {
    title: "Final Exam",
    date: "August 20, 2025",
    ...
    status: "Published",
    statusColor: "#2196F3",
    buttons: ["Grade", "Report"]  // Published - both buttons
  },
  {
    title: "Final Exam",
    date: "August 20, 2025",
    ...
    status: "Ongoing",
    statusColor: "#FF9800",
    buttons: ["Grade"]  // Ongoing - only Grade button
  },
  {
    title: "Final Exam",
    date: "August 20, 2025",
    ...
    status: "Cancelled",
    statusColor: "#F44336",
    buttons: ["Grade"]  // Cancelled - only Grade button
  }
];
...
const UpcomingExams = [
  ...
  },
  {
    ...
    status: "Scheduled",
    statusColor: "#FFC107",
    buttons: ["Grade"]  // Scheduled - only Grade button (Report not allowed)
  }
];
                                ...
                                <View key={idx} style={styles.card}>
                                    ...
                                    <View style={styles.buttonRow}>
                                        {exam.buttons.map((btn, i) => {
                                            // Determine if button should be disabled based on exam status
                                            const isDisabled =
                                                (btn === "Grade" && exam.status === "Scheduled") ||
                                                (btn === "Grade" && exam.status === "Ongoing") ||
